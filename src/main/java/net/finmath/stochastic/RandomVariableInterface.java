...
public interface RandomVariableInterface extends Serializable {
	...
	RandomVariableInterface average(RandomVariableInterface probabilities);
	...
	RandomVariableInterface variance(RandomVariableInterface probabilities);
	...
	RandomVariableInterface sampleVariance();
	...
	RandomVariableInterface standardDeviation();
	...
	RandomVariableInterface standardDeviation(RandomVariableInterface probabilities);
	...
	RandomVariableInterface standardError();
	...
	RandomVariableInterface standardError(RandomVariableInterface probabilities);
