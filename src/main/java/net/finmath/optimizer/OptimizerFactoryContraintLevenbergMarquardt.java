 ...
 */
public class OptimizerFactoryContraintLevenbergMarquardt implements OptimizerFactoryInterface {
	...
	public OptimizerFactoryContraintLevenbergMarquardt(int maxIterations, double errorTolerance, int maxThreads) {
		super();
	...
	public OptimizerFactoryContraintLevenbergMarquardt(int maxIterations, int maxThreads) {
	...
	public OptimizerInterface getOptimizer(final ObjectiveFunction objectiveFunction, double[] initialParameters, double[] lowerBound,double[]  upperBound, double[] parameterSteps, double[] targetValues) {
		ConstraintLevenbergMarquardt levenbergMarquardtWithBounds = new ConstraintLevenbergMarquardt(
				initialParameters,
				targetValues,
				maxIterations,
				maxThreads)
		{	
			...
			@Override
			public void setValuesFunction(double[] parameters, double[] values) throws SolverException {
		...
		OptimizerInterface optimizer = (ConstraintLevenbergMarquardt) levenbergMarquardtWithBounds.setBounds(lowerBound, upperBound).setErrorTolerance(errorTolerance).setParameterSteps(parameterSteps);
	...
	public OptimizerInterface getOptimizer(final DerivativeFunction objectiveFunction, double[] initialParameters, double[] lowerBound,double[]  upperBound, double[] parameterSteps, double[] targetValues) {
		ConstraintLevenbergMarquardt levenbergMarquardtWithBounds = new ConstraintLevenbergMarquardt(				initialParameters,
				targetValues,
				maxIterations,
				maxThreads)
		{	
