...
public class Swaption extends AbstractLIBORMonteCarloProduct {
	...
	public RandomVariableInterface getValue(double evaluationTime, LIBORModelMonteCarloSimulationInterface model) throws CalculationException {
		 ...
		 */
		RandomVariableInterface valueOfSwapAtExerciseDate	= null; //model.getRandomVariableForConstant(/*fixingDates[fixingDates.length-1],*/0.0);
		...
		for(int period=fixingDates.length-1; period>=0; period--)
		{
			...
			valueOfSwapAtExerciseDate = valueOfSwapAtExerciseDate == null ? payoff : valueOfSwapAtExerciseDate.add(payoff);
