...
public class LIBORVolatilityModelFourParameterExponentialForm extends LIBORVolatilityModel {
	...
	public LIBORVolatilityModelFourParameterExponentialForm(AbstractRandomVariableFactory randomVariableFactory, TimeDiscretizationInterface timeDiscretization, TimeDiscretizationInterface liborPeriodDiscretization, double a, double b, double c, double d, boolean isCalibrateable) {
		...
		setParameter(new double[]{a,b,c,d}, true);
	...
	public LIBORVolatilityModelFourParameterExponentialForm(AbstractRandomVariableFactory randomVariableFactory, TimeDiscretizationInterface timeDiscretization, TimeDiscretizationInterface liborPeriodDiscretization, RandomVariableInterface a, RandomVariableInterface b, RandomVariableInterface c, RandomVariableInterface d, boolean isCalibrateable) {
		...
		setParameter(new RandomVariableInterface[]{a,b,c,d}, true);
	...
	public void setParameter(double[] parameter, boolean isAllowed) {
		if(!isAllowed) return;
	...
	public void setParameter(RandomVariableInterface[] parameter, boolean isAllowed) {
		if(!isAllowed) return;
