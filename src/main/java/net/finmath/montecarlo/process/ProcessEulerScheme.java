...
public class ProcessEulerScheme extends AbstractProcess {
	 ...
	 * @param differentiableRandomVariableFactory The random variable factory to construct differentiable random variables
	 */
			...
			for (int componentIndex2 = 0; componentIndex2 < numberOfComponents; componentIndex2++) {
				...
				Callable<RandomVariableInterface> worker = new  Callable<RandomVariableInterface>() {
					public RandomVariableInterface call() throws SolverException {
						...
						RandomVariableInterface diffusionOfComponent		= null;
						...
						for (int factor = 0; factor < numberOfFactors; factor++) {
							...
							diffusionOfComponent = diffusionOfComponent == null ? factorLoading.mult(brownianIncrement) : 
						...
						currentState[componentIndex] = increment.add(currentState[componentIndex]).cache();
