...
public class RandomVariable implements RandomVariableInterface {
	...
	public RandomVariableInterface min() {
		return new RandomVariable(getFiltrationTime(), getMin());
	}

	@Override
	public RandomVariableInterface max() {
		return new RandomVariable(getFiltrationTime(), getMax());
	}

	@Override
	public RandomVariableInterface average() {
		return new RandomVariable(getFiltrationTime(), getAverage());
	}

	@Override
	public RandomVariableInterface average(RandomVariableInterface probabilities) {
		return new RandomVariable(getFiltrationTime(), getAverage(probabilities));
	}

	@Override
	public RandomVariableInterface variance() {
		return new RandomVariable(getFiltrationTime(), getVariance());
	}

	@Override
	public RandomVariableInterface variance(RandomVariableInterface probabilities) {		
		return new RandomVariable(getFiltrationTime(), getVariance(probabilities));
	}

	@Override
	public RandomVariableInterface sampleVariance() {
		return new RandomVariable(getFiltrationTime(), getSampleVariance());
	}
	...
	public RandomVariableInterface standardDeviation(RandomVariableInterface probabilities) {
		return new RandomVariable(getFiltrationTime(), getStandardDeviation());
	}

	@Override
	public RandomVariableInterface standardError() {
		return new RandomVariable(getFiltrationTime(), getStandardError());
	}

	@Override
	public RandomVariableInterface standardError(RandomVariableInterface probabilities) {
		return new RandomVariable(getFiltrationTime(), getStandardError(probabilities));
	}
}
